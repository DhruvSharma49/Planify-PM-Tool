...
export default function TaskCard({ task, index, onClick, draggable = true }) {
  const content = (
    <div
      onClick={onClick}
      className={`task-card bg-card border rounded-xl p-3.5 cursor-pointer group transition-all hover:border-violet-500/20`}
    >
      {/* Labels */}
